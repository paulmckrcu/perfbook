...
\begin{enumerate}
\item	It is impossible to get wrong.  \co{dwim()}
...
\item	Follow common convention and you will get it right.  \co{malloc()}
...
\item	Read the implementation and you will get it wrong.
	The non-\co{CONFIG_PREEMPT} implementation of \co{rcu_read_lock()}.
\item	Read the documentation and you will get it wrong.  DEC Alpha \co{wmb}
	instruction.
...
\ContributedBy{Figure}{fig:easy:Shaving the Mandelbrot Set}{Melissa McKenney}
\end{figure}
