...
\chapter{Ease of Use}
\label{chp:Ease of Use}

\QuickQuizChapter{chp:Ease of Use}
...
a genious, you might be able to anticipate twenty-five of them.''
...
\QuickQuiz{Can a similar algorithm be used when deleting elements?}{
	Yes.
...
\QuickQuiz{Give an exception to this rule.}{
