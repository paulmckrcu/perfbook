...
\item[\IXG{Interrupt}:]
	...
	Once this interrupt handler completes, the CPU re-enables
	interrupts and resumes whatever it was doing when the interrupt
	arrived.
	See also IRQ.
\item[\IXG{Interrupt Handler}:]
	The function executed by a CPU (with further interrupts disabled)
