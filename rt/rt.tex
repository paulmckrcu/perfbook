...
``housekeeping'' CPU to do background processing, for example running
kernel daemons.
...
source of interference and ``OS jitter.''\footnote{
...
algorithms offering wait-free synchronization, and in fact lockless
...
This means that a number of lock-free stacks and queues are appropriate
for real-time use.

In practice, locking is often used in real-time programs, despite theoretical
...
for use in real-time software---and validates common real-time practice.
