...
Interrupts are one good way to introduce large amounts of OS jitter,
thus spoiling bare-metal performance.
...
Kernel threads and daemons are also common OS-jitter offenders.
...
RCU callback invocation.

In-kernel full-system algorithms.

Scheduler throttles real-time tasks.

Hardware as well: Thermal excursions.
Also firmware: SMI handlers.
