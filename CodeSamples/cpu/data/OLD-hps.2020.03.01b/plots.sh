...
set nokey
set label 1 "cmpxchg 1" at 20,350 left
set label 2 "cmpxchg 2" at 110,1030 right
set label 3 "atomic inc" at 110,960 right
set label 4 "write" at 110,890 right
set label 5 "local lock" at 330,160 right
set label 6 "local cmpxchg" at 330,100 right
...
#set yrange [100:10000]
set nokey
set label 1 "blind" at 25,420 left
set label 2 "cmpxchg" at 25,350 left
set label 3 "cmpxchg" at 25,750 left
set label 5 "local lock" at 330,160 right
set label 6 "local cmpxchg" at 330,100 right
