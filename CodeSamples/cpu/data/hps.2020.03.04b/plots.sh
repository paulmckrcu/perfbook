...
set nokey
set label 1 "cmpxchg 1" at 20,330 left
set label 2 "cmpxchg 2" at 20,1040 left
set label 3 "atomic inc" at 20,970 left
set label 4 "write" at 20,900 left
set label 5 "local lock" at 320,170 right
set label 6 "local cmpxchg" at 320,100 right
...
#set yrange [100:10000]
set nokey
set label 1 "blind" at 20,420 left
set label 2 "cmpxchg" at 20,350 left
set label 3 "cmpxchg" at 20,950 left
set label 5 "local lock" at 320,170 right
set label 6 "local cmpxchg" at 320,100 right
