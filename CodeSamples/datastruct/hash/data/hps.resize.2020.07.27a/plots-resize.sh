...
plot "perftestS.2097152.${tag}.dat" w l, "perftestR.2097152.${tag}.dat" w l, "perftestL.4194304.${tag}.dat" w l, "perftestS.262144.${tag}.dat" w l, "perftestR.262144.${tag}.dat" w l, "perftestL.524288.${tag}.dat" w l,  "perftestS.32768.${tag}.dat" w l, "perftestR.32768.${tag}.dat" w l, "perftestL.65536.${tag}.dat" w l
---EOF---
