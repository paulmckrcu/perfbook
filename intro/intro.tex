...
\item[MPI]: This Message Passing Interface~\cite{MPIForum2008} powers
	...
	Its productivity is believed by many to be even less than that
...
distributions.
To create and display a current latex source tree of this book, use the list of
Linux commands shown in
