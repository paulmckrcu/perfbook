...
@@@ this is joint work between Paul, Manish Gupta, Maged Michael,
Phil Howard, Joshua Triplett, and Jonathan Walpole.  Need techreport
to cite. @@@
...
We can then evaluate how wall a given programming language or environment
