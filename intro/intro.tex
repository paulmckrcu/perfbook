...
\QuickQuiz{What about correctness, maintainability, robustness, and so on???}
\QuickQuizAnswer{
...
\QuickQuiz{And if correctness, maintainability, and robustness don't
...
\QuickQuiz{Given that parallel programs are much harder to prove
...
\QuickQuiz{What about just having fun???}
\QuickQuizAnswer{
...
\QuickQuiz{Are there no cases where parallel programming is about something
...
\QuickQuiz{Given how cheap parallel hardware has become, how can anyone
