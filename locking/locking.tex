...
\label{fig:lock:Without qsort() Local Locking Hierarchy}
\end{figure}
...
Figures~\ref{fig:lock:Without qsort() Local Locking Hierarchy} and
...
Figure~\ref{fig:lock:Without qsort() Local Locking Hierarchy},
deadlock can occur.
