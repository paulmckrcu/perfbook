...
\subsection{Sample Implementation Based on Atomic Exchange}
\label{sec:locking:Sample Implementation Based on Atomic Exchange}
...
\subsection{Other Locking Implementations}
\label{sec:locking:Other Locking Implementations}
...
while a lock is held~\cite{Kontothanassis97a}.
Most proprietary UNIX kernels offer some form of scheduler-conscious
synchronization mechanism, largely due to the efforts of a large database
vendor.
...
similar results from a mechanism called \emph{futexes} @@@citation@@@.
