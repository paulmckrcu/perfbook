...
used design techniques.
Of course, we could not resist the urge to include some of our favorites
...
parallel hardware.
The reason for this is that it is really hard to write good parallel
software without at least some understanding of the hardware that it
runs on.
Because hardware is constantly evolving, this chapter will always be
out of date, but we will do our best to keep up.
...
one of the simplest possible problems imaginable, namely that of counting.
...
My impression is that this is the chapter has seen the greatest use in
...
The next three chapters look at how different synchronization approaches
...
to their excellent partitionability.
...
approaches including text emails noting errors and omissions,
