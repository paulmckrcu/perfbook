...
\item	If your main concern is low latency, especially if you are
	working with the Rust language, \ppl{Pekka}{Enberg}'s
	``Latency:
	Reduce delay in software
...
\Cref{chp:Introduction} (``Introduction'') is covered by a 2025 talk
entitled ``Breaking Up is Hard to Do''.
Video is available here:
\url{https://kernel-recipes.org/en/2025/schedule/breaking-up-is-hard-to-do/},
but you will need to supply your own 2x4 Duplo and Lego bricks, two of the
former and sixteen of the latter.
The presentation also touches on
\cref{chp:Partitioning and Synchronization Design}
