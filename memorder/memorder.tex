...
\label{lst:formal:RCU Fundamental Property}
\end{listing}
...
Listing~\ref{lst:formal:RCU Fundamental Property}
...
\label{lst:formal:RCU Readers Provide No Lock-Like Ordering}
\end{listing}
...
be seen in
Listing~\ref{lst:formal:RCU Readers Provide No Lock-Like Ordering}
...
\label{lst:formal:RCU Readers Provide No Barrier-Like Ordering}
\end{listing}
...
Listing~\ref{lst:formal:RCU Readers Provide No Barrier-Like Ordering}
