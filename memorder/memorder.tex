...
\begin{tabular}{l||c||c|c|c|c||c|c|c|c|c|c|c}
	...
	\multicolumn{1}{r}{} &
		\multicolumn{12}{l}{SV: Access to same variable} \\
\end{tabular}
...
\QuickQuizAnswer{
	...
	recent stores, which are applied once the corresponding
...
Therefore, portable code should explicitly order the stores, for
example, as shown in
Listing~\ref{lst:memorder:Enforcing Order of Message-Passing Litmus Test},
...
\end{listing}
	...
	Figure~\ref{lst:memorder:Litmus Test Distinguishing Multicopy Atomic From Other Multicopy Atomic}
	shows such a test.
...
\centering
\theverbbox
\caption{W+WRC Litmus Test With Release}
\label{lst:memorder:W+WRC Litmus Test With Release}
\end{listing}

Listing~\ref{lst:memorder:W+WRC Litmus Test With Release}
...
Just because a load see the old value does \emph{not} mean that
...
The cycle in
Listing~\ref{lst:memorder:W+WRC Litmus Test With Release}
goes through lines~11, 12, 20, 21, 28, 29, 30, and back to line~11.
...
But sometimes time really is on our side, as shown in the next section.
