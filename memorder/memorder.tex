...
the \co{exists} clause on line~25 cannot trigger.
...
\subsection{Pair-Wise Memory Barriers}
...
Table~\ref{tab:memorder:Memory-Barrier Combinations}
...
\label{tab:memorder:Memory-Barrier Combinations}
\end{table*}

\subsection{Pair-Wise Memory Barriers: Portable Combinations}
...
\subsection{Pair-Wise Memory Barriers: Semi-Portable Combinations}
...
\subsubsection{Stores ``Pass in the Night''}
...
\subsection{Pair-Wise Memory Barriers: Dubious Combinations}
...
\subsubsection{Mouth to Mouth, Ear to Ear}
...
Figure~\ref{fig:memorder:Abstract Memory Access Model}.

\begin{figure}[htb]
\centering
%\includegraphics{advsync-/AbstractMemoryAccessModel}
\caption{Abstract Memory Access Model}
\ContributedBy{Figure}{fig:memorder:Abstract Memory Access Model}{David Howells}
\end{figure}
...
So in Figure~\ref{fig:memorder:Abstract Memory Access Model},
...
into~Q before issuing the load of~*Q.\footnote{Although it might sound
	...
	as is described in
	Section~\ref{sec:memorder:Data Dependency Barriers}.}

\section{Device Operations}
\label{sec:memorder:Device Operations}
...
\section{Minimal Guarantees}
\label{sec:memorder:Minimal Guarantees}
...
\subsection{Data Dependency Barriers}
...
\label{sec:memorder:SMP Barrier Pairing}
...
\subsection{Examples of Memory Barrier Pairings}
\label{sec:memorder:Examples of Memory Barrier Pairings}
...
Figure~\ref{fig:memorder:Write Barrier Ordering Semantics}.

\begin{figure*}[htb]
\centering
% \includegraphics{advsync-/WriteBarrierOrdering}
\caption{Write Barrier Ordering Semantics}
\ContributedBy{Figure}{fig:memorder:Write Barrier Ordering Semantics}{David Howells}
\end{figure*}
...
shown in Figure~\ref{fig:memorder:Data Dependency Barrier Omitted}.

\begin{figure*}[htbp]
\centering
% \includegraphics{advsync-/DataDependencyNeeded}
\caption{Data Dependency Barrier Omitted}
\ContributedBy{Figure}{fig:memorder:Data Dependency Barrier Omitted}{David Howells}
\end{figure*}
...
Figure~\ref{fig:memorder:Data Dependency Barrier Supplied}.

\begin{figure*}[htbp]
\centering
% \includegraphics{advsync-/DataDependencySupplied}
\caption{Data Dependency Barrier Supplied}
\ContributedBy{Figure}{fig:memorder:Data Dependency Barrier Supplied}{David Howells}
\end{figure*}
...
shown in Figure~\ref{fig:memorder:Read Barrier Needed}.

\begin{figure*}[htbp]
\centering
% \includegraphics{advsync-/ReadBarrierNeeded}
\caption{Read Barrier Needed}
\ContributedBy{Figure}{fig:memorder:Read Barrier Needed}{David Howells}
\end{figure*}
...
Figure~\ref{fig:memorder:Read Barrier Supplied}.

\begin{figure*}[htbp]
\centering
% \includegraphics{advsync-/ReadBarrierSupplied}
\caption{Read Barrier Supplied}
\ContributedBy{Figure}{fig:memorder:Read Barrier Supplied}{David Howells}
\end{figure*}
...
Figure~\ref{fig:memorder:Read Barrier Supplied, Double Load}.

\begin{figure*}[htbp]
\centering
% \includegraphics{advsync-/ReadBarrierSupplied1}
\caption{Read Barrier Supplied, Double Load}
\ContributedBy{Figure}{fig:memorder:Read Barrier Supplied, Double Load}{David Howells}
\end{figure*}
...
Figure~\ref{fig:memorder:Read Barrier Supplied, Take Two}.

\begin{figure*}[htbp]
\centering
% \includegraphics{advsync-/ReadBarrierSupplied2}
\caption{Read Barrier Supplied, Take Two}
\ContributedBy{Figure}{fig:memorder:Read Barrier Supplied, Take Two}{David Howells}
\end{figure*}
...
\label{sec:memorder:Transitivity}
...
Figure~\ref{fig:memorder:Example of Local Transitivity (Release-Acquire Pair)}:
...
\label{fig:memorder:Example of Local Transitivity (Release-Acquire Pair)}
\end{figure}
...
\section{Locking Constraints}
\label{sec:memorder:Locking Constraints}
...
\section{Memory-Barrier Examples}
\label{sec:memorder:Memory-Barrier Examples}

\subsection{Locking Examples}

\subsubsection{ACQUIRE Followed by RELEASE}
...
\label{tab:memorder:Lock-Based Critical Sections}
\end{table}

\QuickQuiz{}
	Given that operations grouped in curly braces are executed
	concurrently, which of the rows of
	Table~\ref{tab:memorder:Lock-Based Critical Sections}
...
\subsubsection{Ordering with Multiple Locks}
...
Table~\ref{tab:memorder:Ordering With Multiple Locks}, which uses
...
\label{tab:memorder:Ordering With Multiple Locks}
\end{table}
...
\QuickQuiz{}
	...
	Table~\ref{tab:memorder:Ordering With Multiple Locks}?
\QuickQuizAnswer{
...
\subsubsection{Ordering with Multiple CPUs on One Lock}
Suppose, instead of the two different locks as shown in
Table~\ref{tab:memorder:Ordering With Multiple Locks}, both CPUs acquire
the same lock, as shown in
Table~\ref{tab:memorder:Ordering With Multiple CPUs on One Lock}?
...
\label{tab:memorder:Ordering With Multiple CPUs on One Lock}
\end{table}
