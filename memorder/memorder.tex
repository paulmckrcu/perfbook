...
\begin{tabular}{l||c||c|c|c|c||c|c|c|c|c|c}
	...
	\tco{smp_read_barrier_depends()} &  &
		     & Y &   &     &      &   &   &  Y &  Y &     \\
	\hline
	Successful \tco{*_acquire()} & w &
		   R &   &   &     &      & Y & Y &  Y &  Y &   Y \\
	\hline
	Successful \tco{*_release()} & w &
		     & Y & Y &   Y &    W &   &   &    &    &     \\
	\hline
	\tco{smp_rmb()} &   &
		     & Y &   &   R &      & Y &   &  Y &    &   R \\
	...
	\tco{smp_mb()} & S &
		     & Y & Y &   Y &      & Y & Y &  Y &  Y &   Y \\
	\hline
	Successful Non-Relaxed Non-\tco{void} RMW & S &
		   Y & Y & Y &   Y &    Y & Y & Y &  Y &  Y &   Y \\
	\hline
	\tco{smp_mb__before_atomic()} & S &
		     & Y & Y &   Y &      & a & a & a  & a  &   Y \\
	\hline
	\tco{smp_mb__after_atomic()} & S &
		     & a & a &   Y &      & Y & Y &  Y &  Y &     \\
	\multicolumn{12}{c}{~} \\
	\multicolumn{1}{r}{Key:} &
		\multicolumn{11}{l}{C: Cumulativity,
...
The column labeled ``C'' indicates cumulativity, and is explained in
Section~\ref{sec:memorder:Non-Multicopy Atomicity and Cumulativity}.
