...
On cache-coherent platforms, all CPUs agree on the order of reads and
writes to a given variable.
...
having seen use.
This book uses ``cache coherence'' and ``coherence'' interchangeably.
