...
transactions.
In fact, general I/O is not just non-idempotent, it is irrevocable.
...
\item	Introduce weak semantics to transactional memory.
	...
	approaches~\cite{Gramoli:2014:DTP:2541883.2541900}.
...
\ContributedBy{Figure}{fig:future:The STM Vision}{Melissa McKenney}
\end{figure}
...
\ContributedBy{Figure}{fig:future:The STM Reality: Conflicts}{Melissa McKenney}
\end{figure}
...
\ContributedBy{Figure}{fig:future:The STM Reality: Irrevocable Operations}{Melissa McKenney}
\end{figure}
...
\ContributedBy{Figure}{fig:future:The STM Reality: Realtime Response}{Melissa McKenney}
\end{figure}
