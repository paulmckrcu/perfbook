...
measurements, one approach is to extend the traditional cache-warmup phase
to include thermal warmup, with the required warmup duration depending
on the size and thus the thermal inertia of the system under test.
