...
% @@@ Tools: sparse, lockdep, coccinelle, fuzzers, memory models.
...
parallel programming would become routine by the year 2021.\footnote{
	Tools have in fact continued to improve, between fuzzers,
...
problem, perhaps we should at the very least do them the courtesy of listening!
