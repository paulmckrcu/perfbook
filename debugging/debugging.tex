...
Sections~\ref{sec:debugging:Probability and Heisenbugs}
and~\ref{sec:debugging:Heisenbugs and Creating Anti-Heisenbugs}.
...
\label{sec:debugging:Heisenbugs and Creating Anti-Heisenbugs}
...
\item	Test suspicious subsystem in isolation.
