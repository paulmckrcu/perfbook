...
A similar effect occurs for heisenbugs: attempts to track down the bug
...
It is often the case that a given test suite relatively
...
much a bug as is incorrect operation.
...
@@@ move this to later.  start with pitfalls.
