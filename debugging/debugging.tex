...
able to reproduce one of the bugs), but robust\footnote{
	...
	Alternatively, the formal verification described in
	\cref{chp:Formal Verification}
	can turn time-based low probabilities into atemporal certainties,
	at least for sufficiently small programs.}
