...
\item	A type-safety guarantee is provided for the object.
	...
	as will be seen in \cref{sec:defer:Read-Copy Update (RCU)}.
\end{enumerate}
...
\QuickQuizAnswer{
	...
	This same fact allows the non-atomic check in \clnref{check}
	of \cref{lst:together:Linux Kernel kref API}.
	\end{lineref}
} \QuickQuizEnd
...
\cref{lst:together:Linux Kernel fget/fput API}.
