...
How can first-use initialization be implemented under such constraints?
...
% @@@ Make RCU summary hit hard on waiting for readers and describe th
% @@@ other operations as secondary.
