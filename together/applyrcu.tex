...
reader-accessible cache and moved to a holding area, which is represented
by the ``Old readers access'' box in the figure.
...
This approach requires negligible per-data-element storage, inflicts almost
no latency on calling functions, and provides full control of both the
``when'' and ``how'' of reclamation.
