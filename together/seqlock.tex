...
This approach provides sequential consistency to readers, each of which
will either see the effects of a given update or not, with any partial
updates resulting in a read-side retry.
...
it unnecessarily forces read-side retries even when the update did not
