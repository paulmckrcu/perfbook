...
\QuickQuiz{
	...
	Isn't RCU simply a replacement for some reader-writer-locking
	use cases???
}\QuickQuizAnswer{
	It is true that Linux-kernel RCU has most frequently been used
	to replace reader-writer locking,
	However, there are many other RCU use cases.
	See \cref{sec:defer:RCU Usage}.
}\QuickQuizEnd
