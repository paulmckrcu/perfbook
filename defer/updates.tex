...
And although the Linux kernel's Tiny-RCU implementation does achieve
zero-overhead updates as well as zero-overhead reads, this RCU
implementation is confined to single-CPU systems, which does not
constitute much in the way of true concurrency.
