...
Wait for things to finish &
	\pageref{sec:defer:RCU is a Way of Waiting for Things to Finish} \\
Reader-writer locking &
	\pageref{sec:defer:RCU is a Reader-Writer Lock Replacement} \\
Restricted reference-counting &
	\pageref{sec:defer:RCU is a Restricted Reference-Counting Mechanism} \\
Bulk reference-counting &
	\pageref{sec:defer:RCU is a Bulk Reference-Counting Mechanism} \\
Garbage collector &
	\pageref{sec:defer:RCU is a Poor Man's Garbage Collector} \\
Multi-version concurrency control &
	\pageref{sec:defer:RCU is an MVCC} \\
Existence Guarantees &
	\pageref{sec:defer:RCU Provides Existence Guarantees} \\
Type-Safe Memory &
	\pageref{sec:defer:RCU Provides Type-Safe Memory} \\
\bottomrule
\end{tabular}
\caption{RCU Usage}
