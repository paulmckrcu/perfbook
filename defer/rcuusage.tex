...
\item	RCU readers can be enclosed in sequence-locking readers, forcing
	...
	as described in \cref{sec:together:Atomic Move}.
...
This sort of reader-writer-locking use case is often easier to
convert to RCU.
...
boosting~\cite{PaulEMcKenney2007BoostRCU,DinakarGuniguntala2008IBMSysJ}.
It might become necessary to augment SRCU and Tasks Trace RCU with
...
There is also a wide range of counter-based
...
traverse the links to find a version consistent wtih that snapshot.
