...
on a single CPU and by three orders of magnitude on 200~CPUs, as shown in
...
for the same 16-CPU system as the previous plots,
...
magnitude at 200 CPUs.
Preemptible RCU's advantage ranges from about a factor of three at
one CPU up to about three orders of magnitude at 200 CPUs.
...
However, as with reader-writer locking, the performance advantages
