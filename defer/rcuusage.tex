...
This is a weaker guarantee than the existence guarantees in the
previous section, and is therefore quite a bit harder to work with.
Such algorithms in the Linux kernel make use of slab caches, specially
marking these caches so that RCU is used when returning a freed-up
