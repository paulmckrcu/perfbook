...
\QuickQuiz{The \url{synchronize_rcu()} API waits for all pre-existing
...
\QuickQuiz{Hardware interrupt handlers can be thought of as being
...
\QuickQuiz{In general, you cannot rely on \url{synchronize_sched()} to
