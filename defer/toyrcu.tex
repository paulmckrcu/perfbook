...
\url{rcu_read_unlock()} are extremely heavyweight, and, worse yet,
...
are still quite heavyweight, in fact, they are more complex than those
...
Nevertheles, this implementation could conceivably form the basis for a
...
Despite these shortcomings, one could imagine this variant
of RCU being used in production in real-life applications.
