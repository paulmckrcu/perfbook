...
\QuickQuiz{Wouldn't it be cleaner to acquire all the locks, and then
...
\QuickQuiz{Is the implementation shown in
	Figure~\ref{fig:defer:Per-Thread Lock-Based RCU Implementation}
	free from deadlocks?
	Why or why not?}
\QuickQuizAnswer{
...
\QuickQuiz{But what if you hold a lock across a call to
