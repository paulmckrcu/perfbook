...
with \url{rcu_idx} now being a \url{lock} instead of an
\url{atomic_t}.
...
global \url{rcu_gp_ctr} to count nesting, using the definitions shown in
...
In other words, this implementation of \url{rcu_read_lock()} picks up a copy
