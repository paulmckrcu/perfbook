...
\QuickQuizAnswer{
	...
	\item	These same lock operations permit \url{rcu_read_lock()}
		...
		(Exercise for reader: construct such a deadlock.)
...
\QuickQuiz{What are some of the remaining shortcomings of the
	...
	Figures~\ref{fig:defer:RCU Read-Side Using Global Reference-Count Pair}
	and \ref{fig:defer:RCU Update Using Global Reference-Count Pair}?}
\QuickQuizAnswer{
	There are still some serious shortcomings:
	\begin{enumerate}
	\item	The atomic operations in \url{rcu_read_lock()} and
...
\QuickQuiz{What are some of the remaining shortcomings of the
	counter-pair-based implementation shown in
	Figures~\ref{fig:defer:RCU Read-Side Using Per-Thread Reference-Count Pair}
	and
	\ref{fig:defer:RCU Update Using Per-Thread Reference-Count Pair}?}
\QuickQuizAnswer{
...
\QuickQuiz{What are some of the remaining shortcomings of the
	...
	Figure~\ref{fig:defer:RCU Read-Side Using Per-Thread Reference-Count Pair and Shared Update}
	and
	\ref{fig:defer:RCU Shared Update Using Per-Thread Reference-Count Pair}?}
\QuickQuizAnswer{
...
% @@@ cover one of the user-level RCU implementations after LCA2009.
