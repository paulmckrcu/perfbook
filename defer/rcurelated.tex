...
\QuickQuiz{
	...
	data structures, including those concerning network routing,
	security policies, software configuration, and much else besides.
	There was thus much more opportunity for RCU to demonstrate its
	benefits in the 1990s and 2000s than in the 1980s.
	...
	sin in that it ruled out their mechanism's use in software that
	...
	Kung's and Lehman's paper is nevertheless an impressive piece
	of work, especially considering that much of the later work
	(both independent and not) committed many of these same sins,
	plus others as well.
}\QuickQuizEnd
