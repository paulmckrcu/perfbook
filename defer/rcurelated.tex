...
\QuickQuiz{
	...
	To see why they were ahead of their time, consider that three
...
For their part, \ppl{Matthew}{Wilcox}, \ppl{Liam}{Howlett},
\ppl{Suren}{Baghdasaryan}, and others are working towards use of
RCU to enable fine-grained locking of and lockless access to other
