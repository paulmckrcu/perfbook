...
For their part, \ppl{Matthew}{Wilcox}, \ppl{Liam}{Howlett}, and
\ppl{Suren}{Baghdasaryan} are working towards use of RCU to enable
fine-grained locking of and lockless access to other memory-management
data structures.
