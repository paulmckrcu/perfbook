...
But first, te next section defines RCU's core API.
...
which suffice for the upcoming sections introducing RCU and covering
its fundamentals.
...
The \co{rcu_dereference()} macro fetches an RCU-protected pointer.
Conceptually, this is simply a load from memory, but we will see in
