...
Section~\ref{sec:toolsoftrade:Shared-Variable Shenanigans}
to heart, \co{smp_store_release()} is used to \co{NULL} the pointer,\footnote{
...
no-cost readers, in contrast with conventional synchronization primitives
that enforce strict mutual exclusion, thus prohibiting useful concurrent
forward progress.
