...
\QuickQuizAnswer{
	...
	by \co{ACCESS_ONCE()} can help constrain the compiler, at least
...
\QuickQuizAnswer{
	...
	tha in terms of the number of threads or CPUs.
} \QuickQuizEnd
...
For limit counters, we can use a variation on this theme, so that
...
\co{counter}, but where \co{counter} is equal to its \co{countermax}?
