...
\QuickQuizAnswer{
	...
	per-thread counters.
	For the moment, dealing with this added complexit is left as
...
One potential design for limit counters would be to divide the 10,000
...
In short, we want to partition the counters in the common case,
while still allowing counts to flow between CPUs as needed.
One such design is similar to the statistical counting scheme
discussed in
