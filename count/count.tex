...
Counting therefore provides an excellent introduction to many
of the most important issues that arise in parallel programming.
...
\QuickQuizAnswer{
	...
	these sorts of accounting tasks.
...
\section{Statistical Read-Once Counters}
\label{sec:count:Statistical Read-Once Counters}
