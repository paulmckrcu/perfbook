...
gives a pictoral view of different levels of synchronization granularity,
...
as can be seen in
Figure~\ref{fig:SMPdesign:Clock-Frequency Trend for Intel CPUs}\footnote{
...
increasing performance will increasingly require parallelism.
...
a mathematical synchronization-efficienty viewpoint.
