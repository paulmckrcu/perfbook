...
\item[Critical-Section-to-Synchronization Overhead Ratio:]  A uniprocessor,
	...
	program would not need synchronization primitives.
...
\QuickQuiz{In what situation would hierarchical locking work well?}{
...
\QuickQuiz{In Figure~\ref{fig:SMPdesign:Allocator Cache Performance},
...
\QuickQuiz{Allocation failures were observed in the two-thread
