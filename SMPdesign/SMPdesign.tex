...
\QuickQuizAnswer{
	...
	\item	Use transactional memory
		...
		there are reasons for developers to exercise some
		caution~\cite{McKenney2007PLOSTM}.
...
is read-only.
If nobody will change the data, everyone can own it via replication.
