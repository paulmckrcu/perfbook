...
Finally, how should the validation investment be split between
...
In the meantime, the best practice seems to be to focus first on
testing and to reserve explicit work on formal verification for
those portions of the project that are not well-served by testing,
and that have exceptional needs for robustness.
