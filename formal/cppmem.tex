...
\label{sec:Formal Verification and Memory Ordering}
...
\label{fig:sec:formal:CPPMEM Litmus Test}
\end{figure}
...
\label{fig:sec:formal:Meaning of CPPMEM Litmus Test}
\end{figure}

Putting all this together, the C-language equivalent to the entire litmus
test is as shown in
Figure~\ref{fig:sec:formal:Meaning of CPPMEM Litmus Test}.
...
\label{fig:sec:formal:CPPMEM Detects an Error}
\end{figure}
...
Figure~\ref{fig:sec:formal:CPPMEM Detects an Error},
