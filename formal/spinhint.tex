...
\label{sec:formal:What are Promela and Spin?}
...
\label{sec:formal:Promela Example: Non-Atomic Increment}
...
\label{sec:formal:Promela Example: Atomic Increment}
...
\label{sec:formal:Combinatorial Explosion}
