...
\QuickQuiz{
	...
	unsynchronized, hazard-pointer, or RCU runs of this lookup-only
	benchmark.
...
\end{figure}
	...
	which shows performance as a function of the hash-table size,
	measured in number of buckets and maximum number of elements.
	Thus, at a hash-table size of 1,024, there were 1,024~buckets
	and at most 1,024~elements, with the average occupancy being
	512~elements.
	This figure shows the performance dropping off slightly at about
	8,000~elements, where the 1,048,576-byte L2 cache overflows,
	and much more sharply at about 300,000~elements, where the
	40,370,176-byte L3 cache overflows.
	The memory-system bottleneck is quite profound, degrading
	performance by more than an order of magnitude for the large
	hash tables.
...
\QuickQuiz{
	...
	and some care is required to select one that suits your application.
	And just as frequently, significant care and work is required to
...
greater overhead, especially in the presence of updates.
...
Of course, \pplsur{Weiner}{Heisenberg} taught us to live with this sort of
...
\crefrange{fig:datastruct:Growing a Double-List Hash Table; State (a)}
