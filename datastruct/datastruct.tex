...
% For "#B" runs, hash buckets weigh in at 14,680,080 bytes and the hash elements
%    up to 18,874,368 bytes.  The total is 33,554,448 bytes, which in
%    theory fits into the 40,370,176-byte L3 cache, but definitely not
