...
both table, but to throw out the low-order bit when shrinking from
large to small.
...
nor do readers looking up elements~1 and~3.
...
all that effective~\cite{Ellis80},
...
of locks\footnote{
	...
	the developer marks non-shared accesses.}
