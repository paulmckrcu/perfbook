...
\caption{\tco{clock_getttime(CLOCK_REALTIME)} Deviation From Immediately Preceding \tco{clock_gettime(CLOCK_MONOTONIC)}}
...
immediately following \co{clock_getttime(CLOCK_REALTIME)}.
