...
%				   0	   1	   2	   3	    0   8
	...
	1   & 0 & Load 0 (cache miss)
				& 0/S   & $-$/I & $-$/I & $-$/I   & V & V \\
	2   & 2 & Load 0 (cache miss)
				& 0/S   & $-$/I & 0/S   & $-$/I   & V & V \\
	3.1 & 0 & Load 8 (collision, invalidation)
				& $-$/I & $-$/I & 0/S   & $-$/I   & V & V \\
	3.2 & 0 & Load 8 (cache miss)
				& 8/S   & $-$/I & 0/S   & $-$/I   & V & V \\
	4   & 3 & Load 0 (cache miss)
				& 8/S   & $-$/I & 0/S   & 0/S     & V & V \\
...
In step~2, CPU~2 also loads the data at address~0, also incurring a
...
In step~4, CPU~3 loads the data at address~0, incurring a cache miss
...
In step~7, CPU~3 does another CAS operation on the data at address~0.
...
Finally, in step~9, CPU~0 loads the data at address~0, but because this
