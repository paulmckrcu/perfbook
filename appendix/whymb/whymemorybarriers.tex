...
line directly to the exclusive state, thus invalidating CPU~0's cache.
This permits step~6.2 to complete CPU~1's store, transitioning its cache
line to the ``modified'' state.
