...
\begin{itemize}
\item	. % work around a pdflatex bug that otherwise corrupts following line.
...
for \co{call_rcu()}, and thus will not be considered further here.
...
Lines~1-9 shown \co{rcu_batches_completed()} and
...
next lead \co{rcu_node} structure.
