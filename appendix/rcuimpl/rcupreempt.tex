...
\end{center}
\caption{Preemptable RCU with Grace-Period Memory Barriers}
\label{app:rcuimpl:Preemptable RCU with Grace-Period Memory Barriers}
\end{figure}
...
Figure~\ref{app:rcuimpl:Preemptable RCU with Grace-Period Memory Barriers}.
