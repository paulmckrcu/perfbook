...
The arrows link a given \url{rcu_node} structure to its parent.
...
In the first phase (\url{RCU_SAVE_DYNTICK}), the
...
In the second phase (\url{RCU_FORCE_QS}), the
...
\QuickQuiz{Given that \url{force_quiescent_state()} is a two-phase state
