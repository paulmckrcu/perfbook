...
and the assertion at lines~18 and 19 fire if the \co{grace_period_state}
...
Lines~34-40 capture the state of the \co{grace_period_state}
...
show the \co{rcu_nmi_enter()} and \co{rcu_nmi_exit()} functions,
...
so lines~6 and 7 of \co{rcu_nmi_enter} and lines~19 and 20
