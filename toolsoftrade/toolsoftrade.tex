...
{\renewcommand{\lnlblbase}{ln:toolsoftrade:jobcontrol:script}
\begin{VerbatimM}[commandchars=\\\{\}]
...
\renewcommand{\lnrefbase}{ln:toolsoftrade:jobcontrol:script}
...
\renewcommand{\lnrefbase}{ln:api-pthreads:api-pthreads:waitall}
...
\renewcommand{\lnrefbase}{ln:toolsoftrade:forkjoinvar:main}
...
\renewcommand{\lnrefbase}{ln:toolsoftrade:pcreate:mythread}
