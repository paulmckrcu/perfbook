...
\end{minipage}
\vspace{5pt}
	In this script, for a sufficiently large input file
...
\QuickQuizAnswer{
	In fact, a very large fraction of parallel programs that are
	actually used in the world today are likely script-based.
	...
	\end{enumerate}
	These limitations require that script-based parallelism be
...
\QuickQuizAnswer{
	...
	applications using these primitives, as well as the Linux
	implementations.
} \QuickQuizEnd
