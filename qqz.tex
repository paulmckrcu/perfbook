...
\QuickA{}
	...
	\url{pthread_mutex_unlock()} primitives are normally wrapped
...
\QuickA{}
	...
	it can be executed multiple times on the same packet when
	the \url{layer_1()} routing decision changes.

	In real life, this transformation can become arbitrarily complex.
...
\QuickA{}
	...
	\item	Thread 1 invokes \url{synchronize_rcu()}, which
		...
		\url{synchronize_rcu()}, so thread~1 does not wait
