...
\QuickA{}
	...
	Also, note that locks are \emph{not} needed on the
...
\QuickQ{}
	...
	pool size of three, and assuming that the pools are initially
	empty, what is the smallest allocation run
...
\QuickA{}
	...
	See
	Section~\ref{sec:applyrcu:RCU and Per-Thread-Variable-Based Statistical Counters}
	on
	page~\pageref{sec:applyrcu:RCU and Per-Thread-Variable-Based Statistical Counters}
	for more details.
