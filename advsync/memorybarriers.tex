...
\centering
\theverbbox
\caption{Enforcing Ordering of 2+2W Litmus Test}
\label{fig:advsync:Enforcing Ordering of 2+2W Litmus Test}
\end{figure}

\paragraph{Store Followed By Store:}
Figure~\ref{fig:advsync:Enforcing Ordering of 2+2W Litmus Test}
shows the classic \emph{2+2W}.
