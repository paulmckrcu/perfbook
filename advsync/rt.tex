...
to IPIs due to scheduling events, the Linux-kernel \co{smp_call_function()}
and \co{irq_queue_work()} primitives, and much else besides.
In addition, even when the entire system is dedicated to the real-time
application, the most aggressive real-time applications would be best
served by preventing \emph{all} IPIs.
...
This approach might be criticized as having some serious usability
