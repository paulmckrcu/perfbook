...
Nevertheless, if your code is so complex that you need to use validation
tools, you should carefully rethink your design.
For example, a complex implementation of the dynticks interface for
preemptable RCU~\cite{PaulEMcKenney2008dynticksRCU} turned out to
have a much simpler alternative implementation.
